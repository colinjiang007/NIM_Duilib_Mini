...
public:
	...
	virtual void ClearAlpha(const CUiRect& rcDirty, int alpha) override;
	virtual void RestoreAlpha(const CUiRect& rcDirty, const CUiRect& rcShadowPadding, int alpha) override;
private:
	void CleanUp();
